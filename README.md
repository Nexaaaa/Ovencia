<main>
  ...
  <section class="hero">
    ...
    <aside>
      <div class="card">
        <div class="product-image">Photo produit (remplacer avec ton image)</div>
        ...
        <div style="display:flex;gap:8px;margin-top:12px;align-items:center">
          ...
          <div style="color:var(--muted)">Texture riche, absorption rapide</div>
        </div>
    ...
    <div style="display:flex;align-items:flex-start;gap:30px;flex-wrap:wrap">
      ...
      <div style="width:320px">
        <div class="feature">
          ...
          <div class="muted">
            La coquille est stérilisée et micronisée pour préserver sa richesse minérale et son innocuité.
          </div>
        </div>
        ...
        <div class="feature" style="margin-top:12px">
          ...
          <div class="muted">
            Nos soins valorisent un sous-produit naturel pour une beauté durable et consciente.
          </div>
        </div>
      </div>
  ...
  <section id="produits">
    ...
    <div class="grid-3">
      ...
      <div class="card">
        ...
        <div class="product-sub">Coquille micronisée, amande douce, aloe</div>
        <div class="muted" style="margin-top:8px">
  ...
  <section id="contact">
    ...
    <div class="contact-grid">
      ...
      <!-- FORMULAIRE -->
      <form class="card" method="POST" action="mailto:contact@ovencia.example" enctype="text/plain" onsubmit="return handleForm(event)">
        ...
        <div style="margin-top:12px;display:flex;gap:4px;align-items:center">
          ...
          <div class="small">
            ...
            <a href="mailto:contact@ovencia.be">contact@ovencia.be</a>
          </div>
        </div>
      ...
      <div style="padding:18px">
        <div style="background:linear-gradient(180deg,var(--eggshell),#fff);padding:18px;border-radius:12px;box-shadow:0 6px 18px rgba(20,20,20,0.04)">
          <h4>Informations</h4>
          <p class="muted">
